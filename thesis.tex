...
\tikzset{external/export=false}%
\begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south east, xshift=\textwidth, inner sep=0, outer sep=0]{
        \fontsize{10cm}{10cm}\selectfont\textcolor{laccentcolor}{\adjustchkerning{\thechapter}}
    };
\end{tikzpicture}%
\tikzset{external/export=true}%
}
