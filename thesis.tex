...
\usepackage[
    % pagebackref,
    % plainpages=false,
    hypertexnames=false]{hyperref}  % hyperlinking in PDF output
...
\addtokomafont{disposition}{\rmfamily}            % section headings (includes heading font)
...
% \scshape\fontsize{3cm}{3cm}\selectfont\thepart\autodot}
\renewcommand*{\partformat}{
\tikzset{external/export=false}%
\begin{tikzpicture}[remember picture, overlay]
    \node[anchor=center, inner sep=0, outer sep=0, yshift=3cm]
...
\tikzstyle{paperheader}=[anchor=north west,
...
\part{Topological Features in 3D Second-Order Tensor Fields} % (fold)
