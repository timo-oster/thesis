...
\label{ssub:rans}
%
\Todo[inline]{Also discuss URANS}
%
...
segmentation of volumetric \cite{Bremer2009} and surface features
...
segmentation defined by the Morse-Smale complex of a scalar variable
\Todo{don't forget to define in scivis chapter} by solving two graph
...
%
Kwan-Liu Ma gave an overview of the problems and opportunities inherent in
in-situ visualization~\cite{Ma2009}.
%
...
%
If the compression ratio is good, this approach allows to store a much larger
...
%
\subsubsection{Visualization and Analysis Methods} % (fold)
\label{ssub:visualization_and_analysis_methods}
%
Although most work has been done to lay the groundwork for efficient basic
visualization techniques, there have been some developments of more specific
...
data values.
%
A final transfer function can be applied after the fact, allowing for a certain
