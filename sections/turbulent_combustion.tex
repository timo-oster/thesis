...
%
\section[Visualization for DNS of Turbulent Combustion]
        {Visualization for \acs{DNS} of Turbulent Combustion} % (fold)
...
visualization techniques, there have been some developments of more specialized
