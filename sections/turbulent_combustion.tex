...
%
\subsubsection{Turbulent Combustion-Focused Methods} % (fold)
\label{ssub:turbulent_combustion_focused_methods}
%
Going further than basic scientific visualization, several more specialized
methods have been developed for turbulent combustion applications.
%
\Todo[inline]{flesh out paragraph}
%
...
time.
%
Similarly, Schnorr \etal~\cite{Schnorr2018} track cells in a space-filling
topological segmentation defined by the Morse-Smale complex of a scalar variable
...
analysis.
%
% subsubsection turbulent_combustion_focused_methods (end)
%
