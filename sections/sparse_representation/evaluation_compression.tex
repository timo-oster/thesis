...
\begin{figure}[t]
	...
	\Todo[inline]{make horizontal bar chart}
\end{figure}
%
...
\begin{figure}[p]
	...
	\label{fig:CRvMSE}
	\Todo[inline]{Find better solution to display plots on top of each other?
...
\begin{figure}[tb]
	...
	Top: \textsc{Syngas II}: Comparison of reconstruction results for \ce{H} with
 	...
 	densities for \ce{O2}.}
	\label{fig:comp}
	\Todo[inline]{recreate in tikz, rearrange to better fit page geometry,
				  possibly remap colors}
\end{figure}
%
...
\begin{figure}[t]
	...
	\Todo[inline]{Use inline tikz to refer to plots}
\end{figure}
