...
surface $S_f$ by the corresponding shift value $t_{f_i}$ and the direction of
...
\begin{figure}[t!]
	...
	\ruggedtodo[inline]{Recreate in tikz and refer to points by
		image refs/small pictures. Make caption shorter and move details
		to running text.}
\end{figure}
%
...
\begin{figure}[p]
	...
	% $M^{CO_2}_{{max}}$ (right). 
	%
	\ruggedtodo[inline]{Rearrange for paper format, make large enough to fill
		page} }
\end{figure}
%
