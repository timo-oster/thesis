...
principles.
%
\Todo[inline]{As it turns out, PEV lines can also be extracted in the framework
of this new algorithm, as well as degenerate lines}
%
...
\label{sec:cluster}
%
\Todo{This algorithm has already been described in \cref{sub:final_numerical_algorithm}}
...
%
Like for the \ac{PEV} algorithm described in \cref{sec:extracting_pev_lines},
the algorithm typically returns multiple regions that all refer to the same
