...
\begin{figure}
    ...
    \caption{Tensor core lines in a crane arm with a load applied to the end.
             The resulting deformation on the left is scaled by a factor of
             \num{1500}. Significant tensor core lines are only found in the
             lower diagonal rods. The detail image on the right shows the
             tensors are indeed aligned around a common core.}
    \label{fig:crane}
\end{figure}
%
...
\begin{table}
    ...
    \begin{tabular}{lSSS}
        ...
        \midrule
        Cylinder & 65 & 8 & 0.034 \\% & 0.14 \\
        Handle & 235 & 36 & 0.038 \\% & 0.16 \\
        Bumper & 97 & 32 & 0.081 \\% & 0.36 \\
        Crane & 108 & 63 & 0.146 \\% & 0.59 \\
        Spring & 181 & 82 & 0.114 \\
        \bottomrule
