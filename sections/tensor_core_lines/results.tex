...
\begin{figure}
    ...
    \caption{Tensor core lines in a crane arm with a load applied to the end.
             ...
             1500. Significant tensor core lines are only found in the lower
             diagonal rods. The detail image on the right shows the tensors are
             indeed aligned around a common core.}
    \label{fig:crane}
\end{figure}
%
...
\begin{figure}[t]
    ...
    \Todo[inline]{fix baseline of legend ref.}
