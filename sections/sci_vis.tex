...
%
\paragraph{Streamlines} are the simplest form of integral curve in a vector
field.
%
...
%
\paragraph{Pathlines} describe the paths of massless particles moving with a
flow.
%
...
%
\paragraph{Streaklines} are the connected locations of a continuously injected
...
time and injecting more particles.
%
This again mirrors the behavior observed in an experiment.
%

%
\paragraph{Timelines}
%
\paragraph{Integral surfaces}
