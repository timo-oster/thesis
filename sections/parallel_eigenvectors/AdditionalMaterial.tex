\chapter{Proof that the Parallel Eigenvectors Operator Delivers Structurally Stable Lines} % (fold)
\label{cha:proof_pev_stable_lines}

\Todo[inline]{Make this read smoother, repeat theorem with same number. Mention
proof is from Holger.}
