    ...
    \begin{tabular}{lcr}
        ...
        \tikz{
            ...
            \begin{scope}[x={(img.south east)},y={(img.north west)}]
                ...
                \draw[red, thick] (0.71, 0.57) circle[radius=5pt];
                \draw[red, thick] (0.91, 0.56) circle[radius=5pt];
            \end{scope}
        }
    \end{tabular}
    ...
    \begin{tabular}{lr}
        ...
        \tikz{
            ...
            \begin{scope}[x={(img.south east)},y={(img.north west)}]
                ...
                % \foreach \x in {0,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
                % \foreach \y in {0,...,9} { \node [anchor=east] at (0,\y/10) {0.\y}; }
                \draw[red, thick, rotate around={-25:(0.55, 0.5)}]
        ...
        \tikz{
            ...
            \begin{scope}[x={(img.south east)},y={(img.north west)}]
                ...
                % \foreach \x in {0,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
                % \foreach \y in {0,...,9} { \node [anchor=east] at (0,\y/10) {0.\y}; }
                \draw[red, thick] (0.33, 0.5) circle[radius=5pt];
                \draw[red, thick] (0.27, 0.5) circle[radius=5pt];
                \draw[red, thick] (0.485, 0.575) circle[radius=5pt];
                \draw[red, thick] (0.67, 0.64) circle[radius=5pt];
                \draw[red, thick] (0.67, 0.53) circle[radius=5pt];
                \draw[red, thick] (0.72, 0.66) circle[radius=5pt];
                \draw[red, thick] (0.31, 0.4) circle[radius=5pt];
                \draw[red, thick] (0.31, 0.64) circle[radius=5pt];
                \draw[red, thick] (0.585, 0.58) circle[radius=5pt];
            \end{scope}
        } &
        \tikz{
            \node[anchor=south west, inner sep=0pt] (img) at (0,0) {
            ...
            \begin{scope}[x={(img.south east)},y={(img.north west)}]
                ...
                % \foreach \x in {0,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
                % \foreach \y in {0,...,9} { \node [anchor=east] at (0,\y/10) {0.\y}; }
                \draw[red, thick] (0.75, 0.58) ellipse (0.2 and 0.05);
            \end{scope}
        }
    \end{tabular}
    ...
    \begin{tabular}{lcr}
        ...
        \tikz{
            ...
            \begin{scope}[x={(img.south east)},y={(img.north west)}]
                ...
                % \foreach \x in {0,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
                % \foreach \y in {0,...,9} { \node [anchor=east] at (0,\y/10) {0.\y}; }
                \draw[red, thick] (0.58, 0.68) circle[radius=5pt];
                \draw[red, thick] (0.47, 0.5) circle[radius=5pt];
            \end{scope}
        } &
        \tikz{
            \node[anchor=south west, inner sep=0pt] (img) at (0,0) {
            ...
            \begin{scope}[x={(img.south east)},y={(img.north west)}]
                ...
                % \foreach \x in {0,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
                % \foreach \y in {0,...,9} { \node [anchor=east] at (0,\y/10) {0.\y}; }
                \draw[red, thick] (0.75, 0.6) circle[radius=10pt];
                \draw[red, thick] (0.75, 0.4) circle[radius=10pt];
            \end{scope}
        }
    \end{tabular}
