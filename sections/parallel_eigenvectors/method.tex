...
three corners.
%
We denote the set of corner points as $\vx_\triangle = \{\vx_1, \vx_2, \vx_3\}$,
and the set of corner tensors as $\mS_\triangle = \{\mS_1, \mS_2, \mS_3\}$
and $\mT_\triangle = \{\mT_1, \mT_2, \mT_3\}$.
%
