...
\begin{figure}[tb]
    ...
    \Todo[inline]{use small font or smaller in all figures}
\end{figure}
%
...
\begin{itemize}
    ...
    \item The major axis exceeds a threshold $r_\text{size}$
\end{itemize}
%
...
Appendix~\ref{sec:transform_interpolation}. \Todo{move appendix into regular
chapter?}
%
