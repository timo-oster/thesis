...
\Todo{Define the density factor $d$ and discuss it for both datasets}
%
\Cref{fig:simulation_results_spherical} shows the change in number of patches per
...
\cref{fig:simulation_results_spherical}\Todo{Check if autoref works everywhere},
