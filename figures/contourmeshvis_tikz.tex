...
\begin{tikzpicture}[
    ...
    \matrix[matrix of nodes, below=0.8cm of cs] (morph) {
    ...
    \matrix[matrix of nodes, below=0.8cm of morph] (time) {
    ...
    \begin{imgscope}{time-1-1}
        \draw[highlight] (0.63, 0.63) circle (0.3cm);
    \end{imgscope}
    \begin{imgscope}{time-1-2}
        \draw[highlight] (0.63, 0.63) circle (0.3cm);
    \end{imgscope}
    \begin{imgscope}{time-1-3}
        \draw[highlight] (0.63, 0.63) circle (0.3cm);
    \end{imgscope}

    \begin{imgscope}{time-2-1}
        \draw[highlight] (0.32, 0.52) circle (0.3cm);
    \end{imgscope}
    \begin{imgscope}{time-2-2}
        \draw[highlight] (0.31, 0.53) circle (0.3cm);
    \end{imgscope}
    \begin{imgscope}{time-2-3}
        \draw[highlight] (0.29, 0.54) circle (0.3cm);
    \end{imgscope}

    \begin{imgscope}{time-3-1}
        \draw[highlight] (0.65, 0.47) circle (0.3cm);
    \end{imgscope}
    \begin{imgscope}{time-3-2}
        \draw[highlight] (0.65, 0.47) circle (0.3cm);
    \end{imgscope}
    \begin{imgscope}{time-3-3}
        \draw[highlight] (0.65, 0.47) circle (0.3cm);
    \end{imgscope}

    % color bar
    \node[anchor=west, xshift=-0.7cm, yshift=-1mm] (cbar) at (time-3-3.east){
        \begin{axis}[
            scale only axis,
            height=2.8cm,
            hide axis,
