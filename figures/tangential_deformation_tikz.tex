...
%
\begin{tikzpicture}[
    scale=\figurewidth/1cm*0.14,
    line join=round,
    font=\small]
\tikzstyle{facefill} = [fill=mycolor2,fill opacity=0.0]
\tikzstyle{planefill} = [fill=mycolor1,fill opacity=1.0]
...
\begin{scope}[shift={(4, 0)}]
    ...
    \draw [thick, arrows=-latex] (-0.29389263, 0.4045085, 0) -- (-0.58778525, 0.80901699, 0) node [above] {$\mU \cdot \vn$};
