...
\begin{tikzpicture}[
    ...
    label/.style={anchor=north west, align=left, inner sep=0,
                  yshift=\baselineskip, xshift=-0.125\figurewidth},
    ...
    \node[label] at (image2.south east)
    {
        $
        \begin{aligned}
    ...
    \node[label] at (image3.south east)
    {
        $
        \begin{aligned}
    ...
    \node[label] at (image4.south east)
    {
        $
        \begin{aligned}
    ...
    \node[label] at (image5.south east)
    {
        $
        \begin{aligned}
