\begin{tikzpicture}[
    ...
    %     \draw[mycolor4, very thick, rotate around={10:(0.24, 0.81)}]
    %         (0.24, 0.81) ellipse (0.09 and 0.02);
    %     \draw[mycolor4, very thick] (0.45, 0.825) circle[radius=5pt];
    %     \draw[mycolor4, very thick] (0.51, 0.795) circle[radius=5pt];
    % \end{scope}
    ...
    \begin{scope}[
        ...
        % \foreach \x in {0,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
        % \foreach \y in {0,...,9} { \node [anchor=east] at (0,\y/10) {0.\y}; }
        \draw[mycolor4, very thick, rotate around={-2:(0.16, 0.54)}]
            (0.16, 0.54) ellipse (0.15 and 0.02);
        \draw[mycolor4, very thick] (0.74, 0.43) circle[radius=5pt];
        \draw[mycolor4, very thick] (0.91, 0.35) circle[radius=5pt];
    \end{scope}
\end{tikzpicture}