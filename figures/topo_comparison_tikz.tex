...
\begin{tikzpicture}
    ...
    {
        \includegraphics[width=1.0\figurewidth]{figures/truck_bumper_topo_lines_detail2_slim}%
    };
    ...
    {
        \includegraphics[width=1.0\figurewidth]{figures/crane_topo_lines_detail1_slim}%
    };
\end{tikzpicture}